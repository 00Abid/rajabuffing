export const productData = {
    'sauce-pot-buffing': {
        ...
        technicalSpecs: {
            ...
            roughnessValue: "Ra < 0.2μm",
            machineryUsed: "20-Motor Buffing Array"
        },
        process: [
            "Heavy-grit grinding for weld-seam leveling",
            "Sisal wheel pre-polishing for surface scratch removal",
            "Coloring stage with Green Chrome compound for deep reflection",
            "Quality Audit under high-intensity LED reflection test"
        ]
    },
    'milk-pot-polishing': {
        name: "Milk Pot (Pateela) Polishing",
        ...
        technicalSpecs: {
            ...
            finishType: "Super Mirror Finish",
            roughnessValue: "Ra < 0.4μm",
            machineryUsed: "Internal Spindle Buffers"
        },
        process: [
            "Internal surface inspection for draw-marks",
            "Neck-radius polishing with soft-felt mops",
            "High-luster external buffing for showroom appeal",
            "Anti-tarnish wipe-down and batch logging"
        ]
    },
    'wok-pan-finishing': {
        name: "Wok & Kadhai Finishing",
        ...
        technicalSpecs: {
            metalGrades: ["Aluminium", "SS 304", "Tri-ply SS"],
            finishType: "Mirror / Satin Matte",
            roughnessValue: "Ra 0.3μm - 0.6μm",
            machineryUsed: "Automatic Rotary Buffers"
        },
        process: [
            "External scale removal from bottom heat-plate",
            "Riveted handle area detail buffing",
            "Variable RPM buffing to protect Tri-ply layers",
            "Surface prep for laser-branded logos"
        ]
    },
    'silverware-restoration': {
        name: "Silverware Collection Buffing",
        ...
        technicalSpecs: {
            metalGrades: ["Sterling Silver", "EPNS", "Silver Plated"],
            finishType: "Soft Mirror Polish",
            roughnessValue: "Ra < 0.1μm",
            machineryUsed: "Variable Speed Soft-Mop Spindles"
        },
        process: [
            "Assessment of plating thickness and hallmarks",
            "Chemical-free oxidation removal",
            "Precision detailing for ornate patterns",
            "Buffing with high-purity White Rouge"
        ]
    },
    'commercial-utensils-polishing': {
        name: "Commercial Hotelware Polishing",
        ...
        technicalSpecs: {
            metalGrades: ["SS 201", "SS 304", "Brass Decor"],
            finishType: "Export Mirror Finish",
            roughnessValue: "Ra < 0.3μm",
            machineryUsed: "Parallel-Axis Buffing Motors"
        },
        process: [
            "Mass degreasing and surface prep",
            "High-speed automated body polishing",
            "Manual edge-finesse audit",
            "Batch-packing protection prep"
        ]
    },
    'specialty-matte-finishing': {
        ...
        technicalSpecs: {
            ...
            roughnessValue: "Ra 0.5μm - 0.8μm",
            machineryUsed: "8-Unit Dedicated Matte Array"
        },
        process: [
            "Surface leveling for grain uniformity",
            "Application of precision abrasive grit",
            "Secondary smoothing for 'Velvet' hand-feel",
            "Grain-direction alignment check"
        ]
    }
};