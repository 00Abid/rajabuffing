...
const machines = [
    {
        ...
        description: "Our primary high-capacity system designed for bulk utensil finishing. Capable of handling 500+ pieces per hour with consistent mirror luster.",
        video: "/buff.mp4",
        specs: [
    ...
    },
    {
        ...
        description: "Specialized equipment for intricate and high-end matte textures. The core machinery behind our 'Matte Specialist' reputation.",
        video: "/matte.mp4",
        specs: [
    ...
    },
    {
        ...
        description: "Advanced forming machinery for premium utensil shaping and press treatment. Ensures structural integrity before the buffing stage.",
        video: "/press.mp4",
        specs: [
    ...
    },
    {
        ...
        description: "Precision lathe units for utensil bidding and edge smoothing. Essential for luxury cookware safety and aesthetics.",
        video: "/lathe.mp4",
        specs: [
    ...
    },
    {
        ...
        description: "High-precision fiber laser for branding and hallmarking. Permanent, high-contrast marks on any metal grade.",
        video: "/laser.mp4",
        specs: [
        ...
        <main className="pt-32 pb-24 bg-white font-sans antialiased text-slate-900">
            <div className="max-w-7xl mx-auto px-6">
                ...
                <footer className="mt-24 p-12 bg-slate-900 rounded-[3rem] text-white flex flex-col md:flex-row items-center justify-between gap-8">
                    ...
                    <button className="bg-white text-black px-12 py-5 rounded-2xl font-black uppercase tracking-tighter hover:bg-slate-200 transition-all flex items-center gap-3 shadow-xl">
